 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Le;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(Le||(Le={}));const Y2={debug:Le.DEBUG,verbose:Le.VERBOSE,info:Le.INFO,warn:Le.WARN,error:Le.ERROR,silent:Le.SILENT},W2=Le.INFO,X2={[Le.DEBUG]:"log",[Le.VERBOSE]:"log",[Le.INFO]:"info",[Le.WARN]:"warn",[Le.ERROR]:"error"},J2=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),a=X2[e];if(a)console[a](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Nc{constructor(e){this.name=e,this._logLevel=W2,this._logHandler=J2,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Le))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Y2[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Le.DEBUG,...e),this._logHandler(this,Le.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Le.VERBOSE,...e),this._logHandler(this,Le.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Le.INFO,...e),this._logHandler(this,Le.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Le.WARN,...e),this._logHandler(this,Le.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Le.ERROR,...e),this._logHandler(this,Le.ERROR,...e)}}const Z2=(n,e)=>e.some(t=>n instanceof t);let WT,XT;function eD(){return WT||(WT=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function tD(){return XT||(XT=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const hA=new WeakMap,i_=new WeakMap,fA=new WeakMap,cg=new WeakMap,Z_=new WeakMap;function nD(n){const e=new Promise((t,i)=>{const a=()=>{n.removeEventListener("success",o),n.removeEventListener("error",u)},o=()=>{t(Cs(n.result)),a()},u=()=>{i(n.error),a()};n.addEventListener("success",o),n.addEventListener("error",u)});return e.then(t=>{t instanceof IDBCursor&&hA.set(t,n)}).catch(()=>{}),Z_.set(e,n),e}function iD(n){if(i_.has(n))return;const e=new Promise((t,i)=>{const a=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",u),n.removeEventListener("abort",u)},o=()=>{t(),a()},u=()=>{i(n.error||new DOMException("AbortError","AbortError")),a()};n.addEventListener("complete",o),n.addEventListener("error",u),n.addEventListener("abort",u)});i_.set(n,e)}let r_={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return i_.get(n);if(e==="objectStoreNames")return n.objectStoreNames||fA.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Cs(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function rD(n){r_=n(r_)}function sD(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(hg(this),e,...t);return fA.set(i,e.sort?e.sort():[e]),Cs(i)}:tD().includes(n)?function(...e){return n.apply(hg(this),e),Cs(hA.get(this))}:function(...e){return Cs(n.apply(hg(this),e))}}function aD(n){return typeof n=="function"?sD(n):(n instanceof IDBTransaction&&iD(n),Z2(n,eD())?new Proxy(n,r_):n)}function Cs(n){if(n instanceof IDBRequest)return nD(n);if(cg.has(n))return cg.get(n);const e=aD(n);return e!==n&&(cg.set(n,e),Z_.set(e,n)),e}const hg=n=>Z_.get(n);function dA(n,e,{blocked:t,upgrade:i,blocking:a,terminated:o}={}){const u=indexedDB.open(n,e),f=Cs(u);return i&&u.addEventListener("upgradeneeded",m=>{i(Cs(u.result),m.oldVersion,m.newVersion,Cs(u.transaction),m)}),t&&u.addEventListener("blocked",m=>t(m.oldVersion,m.newVersion,m)),f.then(m=>{o&&m.addEventListener("close",()=>o()),a&&m.addEventListener("versionchange",p=>a(p.oldVersion,p.newVersion,p))}).catch(()=>{}),f}const oD=["get","getKey","getAll","getAllKeys","count"],lD=["put","add","delete","clear"],fg=new Map;function JT(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(fg.get(e))return fg.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,a=lD.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(a||oD.includes(t)))return;const o=async function(u,...f){const m=this.transaction(u,a?"readwrite":"readonly");let p=m.store;return i&&(p=p.index(f.shift())),(await Promise.all([p[t](...f),a&&m.done]))[0]};return fg.set(e,o),o}rD(n=>({...n,get:(e,t,i)=>JT(e,t)||n.get(e,t,i),has:(e,t)=>!!JT(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uD{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(cD(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function cD(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const s_="@firebase/app",ZT="0.11.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XD(n){_i(new si("platform-logger",e=>new uD(e),"PRIVATE")),_i(new si("heartbeat",e=>new QD(e),"PRIVATE")),In(s_,ZT,n),In(s_,ZT,"esm2017"),In("fire-js","")}XD("");var rw=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cn{constructor(e){this.value=e}static empty(){return new Cn({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let i=0;i<e.length-1;++i)if(t=(t.mapValue.fields||{})[e.get(i)],!Af(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ju(t)}setAll(e){let t=rn.emptyPath(),i={},a=[];e.forEach((u,f)=>{if(!t.isImmediateParentOf(f)){const m=this.getFieldsMap(t);this.applyChanges(m,i,a),i={},a=[],t=f.popLast()}u?i[f.lastSegment()]=Ju(u):a.push(f.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,i,a)}delete(e){const t=this.field(e.popLast());Af(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Fi(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let i=0;i<e.length;++i){let a=t.mapValue.fields[e.get(i)];Af(a)&&a.mapValue.fields||(a={mapValue:{fields:{}}},t.mapValue.fields[e.get(i)]=a),t=a}return t.mapValue.fields}applyChanges(e,t,i){Hs(t,(a,o)=>e[a]=o);for(const a of i)delete e[a]}clone(){return new Cn(Ju(this.value))}}function kA(n){const e=[];return Hs(n.fields,(t,i)=>{const a=new rn([t]);if(Af(i)){const o=kA(i.mapValue).fields;if(o.length===0)e.push(a);else for(const u of o)e.push(a.child(u))}else e.push(a)}),new Un(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZM{constructor(e){this.Fo=e.Fo,this.Mo=e.Mo}xo(e){this.Oo=e}No(e){this.Bo=e}Lo(e){this.ko=e}onMessage(e){this.qo=e}close(){this.Mo()}send(e){this.Fo(e)}Qo(){this.Oo()}$o(){this.Bo()}Ko(e){this.ko(e)}Uo(e){this.qo(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JC=1e4,ZC=`w:${ky}`,eR="FIS_v2",_P="https://firebaseinstallations.googleapis.com/v1",yP=60*60*1e3,vP="installations",EP="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mR="installations",JP="installations-internal",ZP=n=>{const e=n.getProvider("app").getImmediate(),t=XP(e),i=qs(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},eL=n=>{const e=n.getProvider("app").getImmediate(),t=qs(e,mR).getImmediate();return{getId:()=>$P(t),getToken:a=>YP(t,a)}};function tL(){_i(new si(mR,ZP,"PUBLIC")),_i(new si(JP,eL,"PRIVATE"))}tL();In(XC,ky);In(XC,ky,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zf="analytics",nL="firebase_id",iL="origin",rL=60*1e3,sL="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Uy="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function JL(n,e){const t=await wR(n,{},async()=>{const i=wl({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:a,apiKey:o}=n.config,u=bR(n,a,"/v1/token",`key=${o}`),f=await n._getAdditionalHeaders();return f["Content-Type"]="application/x-www-form-urlencoded",TR.fetch()(u,{method:"POST",headers:f,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function ZL(n,e){return Ka(n,"POST","/v2/accounts:revokeToken",qy(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jo(n,e){return HL(n,"POST","/v1/accounts:signInWithIdp",qy(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zy="5",tI="v",nI="s",iI="r",rI="f",sI=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,aI="ls",oI="p",M_="ac",lI="websocket",uI="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XU extends Yd{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Qa(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return ke.MIN}maxPost(){return ke.MAX}makePost(e,t){const i=Xt(e);return new ke(t,i)}toString(){return".value"}}const JU=new XU;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RI(n){return{type:"value",snapshotNode:n}}function pl(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function vc(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Ec(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function ZU(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l6{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function u6(n,e,t,i){const a=[],o=[];return e.forEach(u=>{u.type==="child_changed"&&n.index_.indexedValueChanged(u.oldSnap,u.snapshotNode)&&o.push(ZU(u.childName,u.snapshotNode))}),Gu(n,a,"child_removed",e,i,t),Gu(n,a,"child_added",e,i,t),Gu(n,a,"child_moved",o,i,t),Gu(n,a,"child_changed",e,i,t),Gu(n,a,"value",e,i,t),a}function Gu(n,e,t,i,a,o){const u=i.filter(f=>f.type===t);u.sort((f,m)=>h6(n,f,m)),u.forEach(f=>{const m=c6(n,f,o);a.forEach(p=>{p.respondsTo(f.type)&&e.push(p.createEvent(m,n.query_))})})}function c6(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function h6(n,e,t){if(e.childName==null||t.childName==null)throw Tl("Should only compare child_ events.");const i=new ke(e.childName,e.snapshotNode),a=new ke(t.childName,t.snapshotNode);return n.index_.compare(i,a)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gd;function $6(n){ae(!gd,"__referenceConstructor has already been defined"),gd=n}function Y6(){return ae(gd,"Reference.ts has not been loaded"),gd}let W6=1;class tS{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ut(null),this.pendingWriteTree_=A6(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function X6(n,e,t,i,a){return d6(n.pendingWriteTree_,e,t,i,a),a?Dl(n,new ja(ov(),e,t)):[]}function J6(n,e,t,i){m6(n.pendingWriteTree_,e,t,i);const a=ut.fromObject(t);return Dl(n,new gl(ov(),e,a))}function Da(n,e,t=!1){const i=p6(n.pendingWriteTree_,e);if(g6(n.pendingWriteTree_,e)){let o=new ut(null);return i.snap!=null?o=o.set(Xe(),!0):an(i.children,u=>{o=o.set(new st(u),!0)}),Dl(n,new cd(i.path,o,t))}else return[]}function zc(n,e,t){return Dl(n,new ja(lv(),e,t))}function Z6(n,e,t){const i=ut.fromObject(t);return Dl(n,new gl(lv(),e,i))}function e5(n,e){return Dl(n,new wc(lv(),e))}function t5(n,e,t){const i=mv(n,t);if(i){const a=pv(i),o=a.path,u=a.queryId,f=En(o,e),m=new wc(uv(u),f);return gv(n,o,m)}else return[]}function qI(n,e,t,i,a=!1){const o=e._path,u=n.syncPointTree_.get(o);let f=[];if(u&&(e._queryIdentifier==="default"||FI(u,e))){const m=Q6(u,e,t,i);G6(u)&&(n.syncPointTree_=n.syncPointTree_.remove(o));const p=m.removed;if(f=m.events,!a){const y=p.findIndex(w=>w._queryParams.loadsAllData())!==-1,E=n.syncPointTree_.findOnPath(o,(w,S)=>Fs(S));if(y&&!E){const w=n.syncPointTree_.subtree(o);if(!w.isEmpty()){const S=s5(w);for(let x=0;x<S.length;++x){const j=S[x],V=j.query,z=$I(n,j);n.listenProvider_.startListening(lc(V),bc(n,V),z.hashFn,z.onComplete)}}}!E&&p.length>0&&!i&&(y?n.listenProvider_.stopListening(lc(e),null):p.forEach(w=>{const S=n.queryToTagMap.get(Zd(w));n.listenProvider_.stopListening(lc(w),S)}))}a5(n,p)}return f}function HI(n,e,t,i){const a=mv(n,i);if(a!=null){const o=pv(a),u=o.path,f=o.queryId,m=En(u,e),p=new ja(uv(f),m,t);return gv(n,u,p)}else return[]}function n5(n,e,t,i){const a=mv(n,i);if(a){const o=pv(a),u=o.path,f=o.queryId,m=En(u,e),p=ut.fromObject(t),y=new gl(uv(f),m,p);return gv(n,u,y)}else return[]}function i5(n,e,t,i=!1){const a=e._path;let o=null,u=!1;n.syncPointTree_.foreachOnPath(a,(w,S)=>{const x=En(w,a);o=o||Os(S,x),u=u||Fs(S)});let f=n.syncPointTree_.get(a);f?(u=u||Fs(f),o=o||Os(f,Xe())):(f=new UI,n.syncPointTree_=n.syncPointTree_.set(a,f));let m;o!=null?m=!0:(m=!1,o=we.EMPTY_NODE,n.syncPointTree_.subtree(a).foreachChild((S,x)=>{const j=Os(x,Xe());j&&(o=o.updateImmediateChild(S,j))}));const p=FI(f,e);if(!p&&!e._queryParams.loadsAllData()){const w=Zd(e);ae(!n.queryToTagMap.has(w),"View does not exist, but we have a tag");const S=o5();n.queryToTagMap.set(w,S),n.tagToQueryMap.set(S,w)}const y=Xd(n.pendingWriteTree_,a);let E=K6(f,e,t,y,o,m);if(!p&&!u&&!i){const w=zI(f,e);E=E.concat(l5(n,e,w))}return E}function GI(n,e,t){const a=n.pendingWriteTree_,o=n.syncPointTree_.findOnPath(e,(u,f)=>{const m=En(u,e),p=Os(f,m);if(p)return p});return OI(a,e,o,t,!0)}function r5(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(p,y)=>{const E=En(p,t);i=i||Os(y,E)});let a=n.syncPointTree_.get(t);a?i=i||Os(a,Xe()):(a=new UI,n.syncPointTree_=n.syncPointTree_.set(t,a));const o=i!=null,u=o?new zs(i,!0,!1):null,f=Xd(n.pendingWriteTree_,e._path),m=jI(a,e,f,o?u.getNode():we.EMPTY_NODE,o);return j6(m)}function Dl(n,e){return KI(e,n.syncPointTree_,null,Xd(n.pendingWriteTree_,Xe()))}function KI(n,e,t,i){if(Ve(n.path))return QI(n,e,t,i);{const a=e.get(Xe());t==null&&a!=null&&(t=Os(a,Xe()));let o=[];const u=ze(n.path),f=n.operationForChild(u),m=e.children.get(u);if(m&&f){const p=t?t.getImmediateChild(u):null,y=MI(i,u);o=o.concat(KI(f,m,p,y))}return a&&(o=o.concat(dv(a,n,i,t))),o}}function QI(n,e,t,i){const a=e.get(Xe());t==null&&a!=null&&(t=Os(a,Xe()));let o=[];return e.children.inorderTraversal((u,f)=>{const m=t?t.getImmediateChild(u):null,p=MI(i,u),y=n.operationForChild(u);y&&(o=o.concat(QI(y,f,m,p)))}),a&&(o=o.concat(dv(a,n,i,t))),o}function $I(n,e){const t=e.query,i=bc(n,t);return{hashFn:()=>(U6(e)||we.EMPTY_NODE).hash(),onComplete:a=>{if(a==="ok")return i?t5(n,t._path,i):e5(n,t._path);{const o=Z4(a,t);return qI(n,t,null,o)}}}}function bc(n,e){const t=Zd(e);return n.queryToTagMap.get(t)}function Zd(n){return n._path.toString()+"$"+n._queryIdentifier}function mv(n,e){return n.tagToQueryMap.get(e)}function pv(n){const e=n.indexOf("$");return ae(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new st(n.substr(0,e))}}function gv(n,e,t){const i=n.syncPointTree_.get(e);ae(i,"Missing sync point for query tag that we're tracking");const a=Xd(n.pendingWriteTree_,e);return dv(i,t,a,null)}function s5(n){return n.fold((e,t,i)=>{if(t&&Fs(t))return[Jd(t)];{let a=[];return t&&(a=BI(t)),an(i,(o,u)=>{a=a.concat(u)}),a}})}function lc(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Y6())(n._repo,n._path):n}function a5(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const a=Zd(i),o=n.queryToTagMap.get(a);n.queryToTagMap.delete(a),n.tagToQueryMap.delete(o)}}}function o5(){return W6++}function l5(n,e,t){const i=e._path,a=bc(n,e),o=$I(n,t),u=n.listenProvider_.startListening(lc(e),a,o.hashFn,o.onComplete),f=n.syncPointTree_.subtree(i);if(a)ae(!Fs(f.value),"If we're adding a query, it shouldn't be shadowed");else{const m=f.fold((p,y,E)=>{if(!Ve(p)&&y&&Fs(y))return[Jd(y).query];{let w=[];return y&&(w=w.concat(BI(y).map(S=>S.query))),an(E,(S,x)=>{w=w.concat(x)}),w}});for(let p=0;p<m.length;++p){const y=m[p];n.listenProvider_.stopListening(lc(y),bc(n,y))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
